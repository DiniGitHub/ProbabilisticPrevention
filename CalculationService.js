...
function initializeDiseaseData(){
    ...
    const brainAndOtherNervousSystem = new Disease('brainAndOtherNervousSystem', 0.055, [0.06, 0.05], ["X", "X", "X"], ["X", "X", "X"], [0.05, "X", "X", "X", "X", "X"], ["X", "X", "X", "X"], ["X", "X", "X"], ["X","X"]);
    const breast = new Disease('breast', 1.7, [0.01, 3.3], [0.2, 1.6, 5.3],["X", "X", "X"],[1.9, 1.4, 0.6, 1.4, 1.7, 1.3], [1.6, 1.7, 2.2, 1.6], ["X", "X", "X"], ["X", "X"]);
    const colonAndRectum = new Disease('colonAndRectum', 0.42, [0.43, 0.41], ["X", "X", "X"], ["X", "X", "X"], [0.44, 0.33, "X", "X", "X", "X"], ["X", "X", "X", "X"], ["X", "X", "X"], ["X", "X"]);
    const nos = new Disease('nos', 0.24, [0, 0.49], ["X", "X", "X"], ["X", "X", "X"], [0.55, 0.24, "X", "X", "X", "X"], ["X", "X", "X", "X"], ["X", "X", "X"], ["X", "X"]);
    const esophagus = new Disease('esophagus', 0.02, [0.02, 0.01], ["X", "X", "X"], ["X", "X", "X"], [0.02, 0.01, "X", "X", "X", "X"], ["X", "X", "X", "X"], ["X", "X", "X"], ["X", "X"]);
    const hodgkinLymphoma = new Disease('hodgkinLymphoma', 0.07, [0.07, 0.06], ["X", "X", "X"], ["X", "X", "X"], [0.08, 0.05, "X", "X", "X", "X"], ["X", "X", "X", "X"], ["X", "X", "X"], ["X", "X"]);
    const kidneyAndRenalPelvis = new Disease('kidneyAndRenalPelvis', 0.18, [0.22, 0.14], ["X", "X", "X"], ["X", "X", "X"], [0.19, 0.15, "X", "X", "X", "X"], ["X", "X", "X", "X"], ["X", "X", "X"], ["X", "X"]);
    const larynx = new Disease('larynx', 0.03, [0.05, 0.01], ["X", "X", "X"], ["X", "X", "X"],[0.03, 0.04, "X", "X", "X", "X"], ["X", "X", "X", "X"], ["X", "X", "X"], ["X", "X"]);
    const leukemia = new Disease('leukemia', 0.14, [0.16, 0.12], ["X", "X", "X"], ["X", "X", "X"], [0.16, 0.08, "X", "X", "X", "X"], ["X", "X", "X", "X"], ["X", "X", "X"], ["X", "X"]);
    const lungAndBronchus = new Disease('lungAndBronchus', 0.18, [0.16, 0.2], ["X", "X", "X"], ["X", "X", "X"], [0.19, 0.14, "X", "X", "X", "X"], ["X", "X", "X", "X"], ["X", "X", "X"], ["X", "X"]);
    ...
    const oralCavityAndPharynx = new Disease('oralCavityAndPharynx', 0.12, [0.17, 0.08], ["X", "X", "X"], ["X", "X", "X"], [0.14, "X", 0.06, "X", "X", "X"], ["X", "X", "X", "X"], ["X", "X", "X"], ["X", "X"]);
    const ovary = new Disease('ovary', 0.07, [0, 0.14], ["X", "X", "X"], ["X", "X", "X"], [0.16, "X", 0.08, "X", "X", "X"], ["X", "X", "X", "X"], ["X", "X", "X"], ["X", "X"]);
    const pancreas = new Disease('pancreas', 0.03, [0.03, 0.03], ["X", "X", "X"], ["X", "X", "X"], [0.03, "X", 0.02, "X", "X", "X"], ["X", "X", "X", "X"], ["X", "X", "X"], ["X", "X"]);
    const prostate = new Disease('prostate', 2.4, [2.4, 0], [0, 1.5, 10.25], ["X", "X", "X"], [2.6, 1.1, 2.9, 1.1, 0.8, "X"], [2.0, 2.6, 2.6, 2.6], ["X", "X", "X"], ["X", "X"]);
    const stomach = new Disease('stomach', 0.04, [0.04, 0.03], ["X", "X", "X"], ["X", "X", "X"], [0.04, "X", 0.04, "X", "X", "X"], ["X", "X", "X", "X"], ["X", "X", "X"], ["X", "X"]);
    const thyroid = new Disease('thyroid', 0.27, [0.13, 0.42], ["X", "X", "X"], ["X", "X", "X"], [0.30, "X", 0.13, "X", "X", "X"], ["X", "X", "X", "X"], ["X", "X", "X"], ["X", "X"]);
    const urinaryBladder = new Disease('urinaryBladder', 0.22, [0.34, 0.11], ["X", "X", "X"], ["X", "X", "X"], [0.26, "X", 0.08, "X", "X", "X"], ["X", "X", "X", "X"], ["X", "X", "X"], ["X", "X"]);
    const mentalHealth1 = new Disease('mentalHealth1', 11.3, [8.4, 14.1], [13.8, 10.9, 7], ["X", "X", "X"], [12.2, 9.8, 18.4, 9.1, 5.5, 17.2], [11.7, 11.3, 11, 11.3], ["X", "X", "X"], [11.9, "X"]);
    const mentalHealth2 = new Disease('mentalHealth2', 4.5, [3.7, 5.2], [4.8, 4.7, 3.6], ["X", "X", "X"], [4.6, 3.5, 10.3, 4.2, 2.5, "X"], [4, 4.3, 4, 5.1], ["X", "X", "X"], [6.5, "X"]);
    const obesity = new Disease('obesity', 32.8, [32.6, 33.0], [31.1, 38.3, 27.7], ["X", "X", "X"], [32.3, 44, 37, 18.4, 11, 32.2], [30.1, 35.3, 28.5, 35.1], ["X", "X", "X"], ["X", "X"]);
    ...
    return [diabetes, cancerAny, brainAndOtherNervousSystem, breast, colonAndRectum, nos, esophagus, hodgkinLymphoma, kidneyAndRenalPelvis, larynx, leukemia, lungAndBronchus, skinCancerAny, nonHodgkinLymphoma, oralCavityAndPharynx, syphilis, ovary, pancreas, prostate, stomach, thyroid, urinaryBladder, mentalHealth1, mentalHealth2, obesity, arthritis, heartAttack, diagnosedHypertension, highCholesterol, coronaryHeartDisease, chlamydia, gonorrhea, alzheimersDisease];
  }
  ...
  function calculateDiseaseProbabilities({ sex, age, bmi, race, region, smokerLevel, physicalInactivity }) {
    ...
    const userProbabilities = new GeneralUserProbabilities([49.5,50.5],[60.3,25.4, 16.4],[30.7,42.4, 9.2],[59.3,18.9,12.6,2.3,5.9,0.2,0.7],[0.237,0.2074,0.1722,0.3833],[88.8,11.2,6.744],[25.5,74.5])
    ...
    for (let disease of diseases) {
        if (disease.name === "obesity"){
            if (user.BMI === 0){
                probabilities["obesity"] = 0;
            } else {
                probabilities["obesity"] = calculateProbability(user, obesity, userProbabilities);
            }
        }
        else {
